...
# Load the workbook
wb = openpyxl.load_workbook('exel file/Project Information 2_final.xlsx')

# The external file path prefix to find and replace
...
# Save
wb.save('exel file/Project Information 2_final.xlsx')
